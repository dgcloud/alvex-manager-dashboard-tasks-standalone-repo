...
public interface AlvexContentModel {
	...
	final static String ALVEXCM_MODEL_PREFIX = "alvexcm";
	...
	final static QName TYPE_WORKFLOW_RELATION = QName.createQName(ALVEXCM_MODEL_URI, "workflowRelation");
	...
	final static QName PROP_RELATION_TYPE = QName.createQName(ALVEXCM_MODEL_URI, "relationType");
	final static QName PROP_WORKFLOW_INSTANCE = QName.createQName(ALVEXCM_MODEL_URI, "workflowInstance");
	final static QName PROP_RELATED_OBJECT = QName.createQName(ALVEXCM_MODEL_URI, "relatedObject");
	...
	final static String RELATION_TYPE_RELATED_WORKFLOW = "related-workflow";
}
